...
export function Navigationbar() {
  ...
  const { isAdmin, isLoading, isHospital, user } = useUser();
  ...
  return (
    <Navbar fluid rounded className="shadow-lg md:py-4 py-2">
      ...
      <div className="flex md:order-2 md:mr-24 items-center gap-4">
        <LanguageSwitcher />

        {state?.isAuthenticated ? (
          user && !isAdmin && !isHospital ? (
            <Dropdown
              arrowIcon={false}
              inline
              label={
            ...
            >
              ...
              <Dropdown.Item onClick={() => navigate("/profile")}>
                <div className="flex items-center">
                  ...
                  <span>{t("donor_profile", { ns: "navbar" })}</span>
                </div>
              </Dropdown.Item>
                ...
                <>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span>{t("organization_profile", { ns: "navbar" })}</span>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => navigate("/organized-camps")}>
                    <div className="flex items-center">
                      ...
                      <span>{t("organized_camps", { ns: "navbar" })}</span>
                    </div>
                  </Dropdown.Item>
                </>
              )}
              <Dropdown.Item onClick={() => navigate("/donations")}>
                <div className="flex items-center">
                  ...
                  <span>{t("donations", { ns: "navbar" })}</span>
                </div>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate("/appointments")}>
                <div className="flex items-center">
                  ...
                  <span>{t("appointments", { ns: "navbar" })}</span>
                </div>
              </Dropdown.Item>
              <Dropdown.Divider />
            ...
            >
              ...
              <Dropdown.Item onClick={() => navigate("/admin/appointments")}>
                ...
                {t("admin_appointments", { ns: "navbar" })}
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate("/admin/camps")}>
                ...
                {t("admin_camps", { ns: "navbar" })}
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate("/admin/blood-requests")}>
                <svg
                  className="w-[16px] h-[16px] mr-2 fill-[#8e8e8e]"
                  viewBox="0 0 576 512"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Dropdown.Item onClick={() => navigate("/admin/stock")}>
                ...
                {t("admin_stocks", { ns: "navbar" })}
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate("/admin/subscription")}>
                <div className="flex items-center">
                  <svg
                    className="w-[15px] h-[15px] mr-2 fill-[#8e8e8e]"
                    viewBox="0 0 576 512"
                  ...
                  <span>{t("admin_subscription", { ns: "navbar" })}</span>
                </div>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate("/admin/donors")}>
                <div className="flex items-center">
                  ...
                  <span>{t("admin_donors", { ns: "navbar" })}</span>
                </div>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate("/admin/organizations")}>
                <div className="flex items-center">
                  ...
                  <span>{t("admin_organizations", { ns: "navbar" })}</span>
                </div>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate("/admin/hospitals")}>
                <div className="flex items-center">
                  <svg
                    className="w-[15px] h-[15px] mr-2 fill-[#8e8e8e]"
                    viewBox="0 0 384 512"
                  ...
                  <span>{t("admin_hospitals", { ns: "navbar" })}</span>
                </div>
              </Dropdown.Item>
            ...
            >
              ...
              <Dropdown.Item onClick={() => navigate("/hospital-registration")}>
                <div className="flex items-center">
                  <svg
                    className="w-[14px] h-[14px] mr-2 fill-[#8e8e8e]"
                    viewBox="0 0 448 512"
              ...
              >
                <div className="flex items-center">
                  ...
                  <span>{t("blood_requests", { ns: "navbar" })}</span>
                </div>
              </Dropdown.Item>
