...
const PendingCamps = ({ camps }: { camps: Camp[] }) => {
  ...
  useEffect(() => {
    ...
    setCurrentPage(1);
  }, [pendingCamps, searchTerm, dateFilter, cityFilter, filterType]);
    ...
    <div className="flex justify-center mt-8">
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg max-w-7xl w-full mb-20">
        ...
        {filteredCamps.length > itemsPerPage && (
          <div className="flex justify-between items-center px-4 py-3 bg-white dark:bg soggiorno-900 border-t border-gray-200 dark:border-gray-700">
