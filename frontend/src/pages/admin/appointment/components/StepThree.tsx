        ...
        if (response.data.assessment) {
          setFormData({
            bagIssue: {
              ...
              bloodBagType: response.data.bagIssue.bloodBagType,
              officerSignature: response.data.bagIssue.officerSignature,
            },
          });
        }
      } catch (error) {
  ...
  const handleSubmit = async () => {
    if (appointment?.status === "Assessed") {
      ...
      try {
        ...
        const requestData = {
          bagIssue: {
            hbLevel: formData.bagIssue.hbLevel,
              ...
              <div className="mt-4 space-y-6">
                  ...
                  <div className="flex items-center space-x-4">
                    <label className="inline-flex items-center">
                      <input
                        ...
                        name="hbLevel"
                        value=">12.5g/dl"
                        checked={formData.bagIssue.hbLevel === ">12.5g/dl"}
                        onChange={handleInputChange}
                        className="form-radio h-4 w-4 text-red-600 focus:ring-red-500"
                        required
                      />
                      <span className="ml-2 text-gray-700">{">"}12.5g/dl</span>
                    </label>
                    <label className="inline-flex items-center">
                      <input
                        type="radio"
                  ...
                  <div className="flex items-center space-x-4">
                    <label className="inline-flex items-center">
                      <input
                        ...
                        name="bloodBagType"
                        value="Q"
                        checked={formData.bagIssue.bloodBagType === "Q"}
                        onChange={handleInputChange}
                        className="form-radio h-4 w-4 text-red-600 focus:ring-red-500"
                        required
                      />
                      <span className="ml-2 text-gray-700">Q</span>
                    </label>
                    <label className="inline-flex items-center">
                      <input
                        type="radio"
                        name="bloodBagType"
                        value="T"
                        checked={formData.bagIssue.bloodBagType === "T"}
                        onChange={handleInputChange}
                        className="form-radio h-4 w-4 text-red-600 focus:ring-red-500"
                        required
                      />
                    ...
                    <label className="inline-flex items-center">
                      <input
                        ...
                        name="bloodBagType"
                        value="D"
                        checked={formData.bagIssue.bloodBagType === "D"}
                        onChange={handleInputChange}
                        className="form-radio h-4 w-4 text-red-600 focus:ring-red-500"
                        required
                      />
                    ...
                    <label className="inline-flex items-center">
                      <input
                        ...
                        name="bloodBagType"
                        value="S"
                        checked={formData.bagIssue.bloodBagType === "S"}
                        onChange={handleInputChange}
                        className="form-radio h-4 w-4 text-red-600 focus:ring-red-500"
                        required
                      />
                ...
                <div className="w-full">
                  ...
                  <input
                    ...
                    value={formData.bagIssue.officerSignature}
                    onChange={handleInputChange}
