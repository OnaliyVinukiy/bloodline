...
const RejectedHospitals = ({ hospitals }: { hospitals: Hospital[] }) => {
  ...
  // Filter rejected hospitals
  useEffect(() => {
    const rejectedHospitals = hospitals.filter(
      (hospital) => hospital.status === "rejected"
    );

    let results = [...rejectedHospitals];
        ...
        <div className="p-6 bg-white dark:bg-gray-900">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <div className="mt-4 md:mt-0 text-sm text-gray-500 dark:text-gray-400">
              {filteredHospitals.length} rejected request(s)
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-4 md:space-y-0 pb-4">
            <div className="relative w-full md:w-1/3">
              ...
              <input
                type="text"
                id="table-search-rejected-hospitals"
