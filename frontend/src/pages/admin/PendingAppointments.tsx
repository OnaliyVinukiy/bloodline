...
const PendingAppointments = () => {
  ...
  return (
    <div className="flex justify-center mt-8">
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg max-w-6xl w-full">
        ...
        <table className="mt-4 mb-4 w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {appointments.map((appointment: any) => (
              ...
              >
                <td className="px-6 py-4">{appointment.donorInfo.fullName}</td>
