        ...
        <div className="relative bg-white rounded-xl shadow-2xl overflow-hidden p-1">
          ...
          <div className="relative bg-white rounded-xl p-8 z-10">
            ...
            <div className="bg-gray-50 p-8 rounded-lg border border-gray-100 shadow-sm">
              <div className="mt-4 mb-8 font-roboto font-medium font-notoserif text-md md:text-xl text-left text-gray-700 leading-relaxed">
                <ul className="list-disc pl-6 mt-6 space-y-4">
                  <li>
                    වැඩසටහන අවසානයේ, ලේ බැංකුව හා එක් වී වැඩසටහන පිළිබඳ
                    සමාලෝචනයක් සිදු කිරීම වැදගත් ය.
                  </li>
                  <li>
                    විශාල රුධිර පරිත්‍යාගශිලින් සංඛ්‍යාවක් සහභාගි වූ පමණින් ලේ
                    දන් දීමේ කඳවුරක් සාර්ථක වන්නේ නැත. රුධිරය පරිත්‍යාග කිරීමට
                    පැමිණෙන පරිත්‍යාගශීලීන් අතුරින් වෛද්‍යවරයා විසින් නුසුදුසු
                    යැයි තීරණය කරන දායකයින් සංඛ්‍යාව අඩු වීම ද ගුණාත්මක කදවුරක
                    ලක්ෂණයකි.
                  </li>
                  <li>
                    පසු ව සිදු කරන පරික්‍ෂණවල දී රුධිරය මඟින් බෝ විය හැකි
                    රෝගාකාරක පරිත්‍යාගශීලීන්ගේ රුධිරයේ නොමැති වීම ද යහපත් කඳවුරක
                    ලක්ෂණයකි.
                  </li>
                  <li>
                    අඩුපාඩු සොයා බලා අවබෝධ කර ගැනීමෙන්, ඔබගේ ඉදිරි වැඩසටහන්
                    වඩාත් සාර්ථක වනු ඇත.
                  </li>
                </ul>
              </div>
            ...
            <div className="flex justify-between font-notoserif mt-8">
              <button
