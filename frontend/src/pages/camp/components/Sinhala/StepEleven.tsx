            ...
            <div className="text-center mb-8">
              <div className="flex flex-col items-center gap-4">
                ...
                <h2 className="text-2xl md:text-4xl font-bold font-notoserif text-gray-800">
                  රුධිර පරිත්‍යාග කඳවුර සඳහා දිනයක් වේලාවක් වෙන්කරවා ගන්න
                </h2>
              </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg border border-gray-100 shadow-sm">
              <div className="mt-4 space-y-6">
                <div className="mb-6 p-4 bg-yellow-100 rounded-lg">
                  <p className="text-yellow-800 font-notoserif font-semibold">
                    රුධිර පරිත්‍යාග කඳවුර සඳහා දිනයක් සහ වේලාවක් තෝරන්න.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center p-4">
                  <div className="mb-6">
                    <Label
                      htmlFor="date"
                      className="block mb-2 text-md font-semibold font-notoserif"
                    >
                      දිනයක් තෝරන්න
                    </Label>
                    <DatePicker
                    ...
                    <div className="w-full">
                      <div className="mb-6">
                        <Label
                          ...
                          className="block mb-2 text-md font-semibold font-notoserif"
                        >
                          ආරම්භ වන වේලාව තෝරන්න
                        </Label>
                        <select
                          id="start-time"
                          value={startTime || ""}
                          onChange={(e) => setStartTime(e.target.value)}
                          className="bg-indigo-50 border font-notoserif border-indigo-300 text-indigo-900 rounded-lg p-2 w-full"
                        >
